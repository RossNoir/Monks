...
class SkitCreator(QMainWindow):
    def __init__(self):
        ...
        self.ollama_models = [] # <<< NEW >>> Initialize list for models
        ...
        self.populate_ollama_models() # This now uses your new function
    ...
    def populate_ollama_models(self): # <<< UPDATED >>> Using your proven requests-based function
