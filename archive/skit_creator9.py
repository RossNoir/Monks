...
class SkitCreator(QMainWindow):
    ...
    def generate_skit_batch(self):
        ...
        for i in range(batch_count):
            ...
            try:
                ...
                # <<< FIXED >>> New, more robust audio assembly logic
                ...
                for item in timeline:
                    ...
                    if event['type'] == 'dialogue':
                        ...
                        quiet_laugh = event['segment'] - 18 # Quieter laugh
    ...
    def generate_seinfeld_skit(self):
        ...
        try:
            ...
            # <<< FIXED >>> New, more robust parsing logic
            parsed_script = []
            ...
            # Diagnostic print to show what the parser found
